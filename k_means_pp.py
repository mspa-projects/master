# -*- coding: utf-8 -*-
'''
This module implements the K-means++ Model of clustering
...
Output:
    ...
    score: silhouette coefficient for K-means++ model
...
# This module builds the k-means++ model, fits to the training data
# and returns the silhouette score
def buildKmeansppClusterModel(
		trainingData,
    ...
    clf = KMeans(init='k-means++', n_clusters=clusterComp, max_iter = 100, n_init=10)
    clf.fit(X)
...
def main():
    df_countyCluster, score = buildKmeansppClusterModel(
