# -*- coding: utf-8 -*-
'''
This module implements the Gaussian Mixture Model of clustering
...
Output:
    ...
    score: silhouette coefficient for gaussian mixture model
...
# This module builds the gaussian mixture model, fits to the training data
# and returns the silhouette score
def buildGmmClusterModel(
    trainingData,
    ...
    clf = mixture.GMM(n_components=clusterComp, covariance_type='tied', n_iter=20, n_init=50)
    clf.fit(X)
...
def main():
    df_countyCluster, score = buildGmmClusterModel(
